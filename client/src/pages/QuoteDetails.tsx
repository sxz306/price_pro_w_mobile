                    ...
                    <div key={item.id} className="bg-card border border-border/50 rounded-2xl p-5 shadow-sm">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        {(() => {
                          ...
                          const marginBg = (val: number | null) => {
                                ...
                                {(() => {
                                  ...
                                  return (
                                    <div className="flex-shrink-0">
                                      <p className="text-[11px] font-semibold text-primary uppercase tracking-wider mb-2">Suggested Line Price</p>
                                      <div className="rounded-xl border border-primary/30 bg-primary/5 overflow-hidden shadow-sm p-4 flex flex-col min-h-[130px]">
                                        <div className="flex items-center gap-1.5 mb-1">
                                          <div className="w-5 h-5 rounded-md bg-primary/15 flex items-center justify-center">
                                            <Lightbulb className="w-3 h-3 text-primary" />
                                          </div>
                                          <p className="text-[10px] text-primary uppercase tracking-wider font-medium">Optimal</p>
                                        </div>
                                    ...
                                    <div className={`p-4 flex flex-col min-h-[130px] ${marginBg(marginPct)}`}>
                                      ...
                                      <div className="mt-auto">
                                        <p className="text-[10px] text-muted-foreground leading-relaxed">
                                          {lineCost != null ? <><span className="opacity-70">(</span>{formatCurrency(adjLinePrice)} − {formatCurrency(lineCost)}<span className="opacity-70">)</span> / {formatCurrency(lineCost)}</> : "—"}
                                        </p>
                                      </div>
                                    </div>
